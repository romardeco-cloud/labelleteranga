...
from .views import POSClosingView, POSCustomerOrdersView, POSDailyMenuView, POSAckSentView, POSAcknowledgeOrdersView, POSDrawerView, POSFinalizeOrderView, POSLoyaltyView, POSPendingOrdersView, POSProductListView, POSSaleView
