...
class CompanySeal(models.Model):
    ...
    contact_address = models.CharField("Adresse (pied de page)", max_length=200, blank=True)
    contact_phone = models.CharField("Téléphone (pied de page)", max_length=60, blank=True)
    contact_whatsapp = models.CharField("WhatsApp (pied de page)", max_length=60, blank=True)
    contact_email = models.CharField("Courriel (vide = courriel par défaut)", max_length=120, blank=True)
    contact_website = models.CharField("Site web", max_length=120, blank=True)
    contact_extra = models.TextField("Lignes supplémentaires (une par ligne)", max_length=500, blank=True)
